...
<header>
	...
	<div class="desktop-blue-menu full-width">
		<div class="container">
			<div class="col-2">
					...
					<div class="swiper-wrapper">
						...
						<div class="news-content-hover">
							<div class="news-content-hover-wrapper">
								 ...
								 ?>
								<p><?php echo trimText($textToTrim, "...", 200); ?></p>
...
<!-- ++++++++++++++
Section: Subscription form in bottom
++++++++++++++ -->

<section class="bottom-form">
	<div class="container">
		<div class="col-2">
			<img src="compressed/images/re_logo_white.png" alt="Reimagine Logo">
			<div class="row">
				<ul class="full-width social-3">
					<li><a href="#"><i class="fa fa-facebook"></i></a></li>
					<li><a href="#"><i class="fa fa-twitter"></i></a></li>
					<li><a href="#"><i class="fa fa-linkedin"></i></a></li>
					<li><a href="#"><i class="fa fa-instagram"></i></a></li>
			...
			<div class="row">
				<p>Copyright <?php echo date('Y'); ?> Samsung</p>
			</div>
		</div>
		<div class="col-2">
			
			<div class="bot-sub-form clear-after">
					<form action="" class="row">
						<div class="row">
							<p>Want to keep up to date with the world?</p>
						</div>
